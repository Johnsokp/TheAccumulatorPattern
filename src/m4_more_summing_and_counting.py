...
def run_test_count_cosines_from():
    ...
    # Test 3:
    expected = 2
    answer = count_cosines_from(3, 5, -0.75)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 2
    answer = count_cosines_from(5, 8, 0.7)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 1
    answer = count_cosines_from(3, 5, 0)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 1
    answer = count_cosines_from(4, 6, 0.5)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 0.7833  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(3, 5)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected = 2.0833  # This is APPROXIMATELY the correct answer.
